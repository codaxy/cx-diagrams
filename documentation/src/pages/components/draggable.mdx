...
export const code = `interface Position {
    offsetX: number;
    offsetY: number;
}
...
<Diagram center showGrid>
    <Flow direction="right" gap={2}>
        <Draggable
            offsetX={m.cell1.offsetX}
            offsetY={m.cell1.offsetY}
        >
            <Cell width={3}>
                <Shape
                    text="Drag me"
        ...
        <Draggable
            offsetX={m.cell2.offsetX}
            offsetY={m.cell2.offsetY}
        >
            <Cell width={3}>
                <Shape
                    text="Drag me too"
    ...
    <Draggable
        offsetX={m.group.offsetX}
        offsetY={m.group.offsetY}
    >
