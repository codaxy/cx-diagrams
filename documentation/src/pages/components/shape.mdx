...
<Split>
  <Prose>
    ...
    The `Shape` component is used to create shapes appearing on the diagram. Shapes are usually `circles`, `rectangles` and `rhombuses`
    and can represent various things such as network devices and interfaces, departments, roles, etc. Shapes support the `text` property
    and can easily be interconnected using lines. Shapes are clickable and support context menus.
...
<Split>
  <Prose class="pb-0">## Configuration</Prose>
