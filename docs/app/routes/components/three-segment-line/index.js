         ...
         <Split>
            <Pad>
               ...
               <Md>
                    ...
                    <ImportPath path='import { ThreeSegmentLine } from "cx-diagrams"' />
            ...
            <CodeSnippet class="border-t border-b py-4 max-h-[500px] overflow-auto">{`
               <Diagram unitSize={64} center showGrid>
                  <Flow gap={1} align="center">
                     ...
                     <ThreeSegmentLine from="1" to="2" stroke="black">
                        <Shape anchors="0 0 0 0" margin={-3} shape="circle" fill="white" stroke="blue" />
                        <Shape anchors="1 1 1 1" margin={-3} shape="circle" fill="white" stroke="blue" />
                     </ThreeSegmentLine>
                     <ThreeSegmentLine from="1" to="3" stroke="black">
                        <Shape anchors="0 0 0 0" margin={-3} shape="circle" fill="white" stroke="blue" />
                        <Shape anchors="1 1 1 1" margin={-3} shape="circle" fill="white" stroke="blue" />
                     </ThreeSegmentLine>
                     <ThreeSegmentLine from="1" to="4" stroke="black">
                        <Shape anchors="0 0 0 0" margin={-3} shape="circle" fill="white" stroke="blue" />
                        <Shape anchors="1 1 1 1" margin={-3} shape="circle" fill="white" stroke="blue" />
                     </ThreeSegmentLine>
                     <ThreeSegmentLine from="2" to="6" stroke="black">
                        <Shape anchors="0 0 0 0" margin={-3} shape="circle" fill="white" stroke="blue" />
                        <Shape anchors="1 1 1 1" margin={-3} shape="circle" fill="white" stroke="blue" />
                     </ThreeSegmentLine>
                     <ThreeSegmentLine from="3" to="5" stroke="black">
                        <Shape anchors="0 0 0 0" margin={-3} shape="circle" fill="white" stroke="blue" />
                        <Shape anchors="1 1 1 1" margin={-3} shape="circle" fill="white" stroke="blue" />
                     </ThreeSegmentLine>
                     <ThreeSegmentLine from="4" to="7" stroke="black">
                        <Shape anchors="0 0 0 0" margin={-3} shape="circle" fill="white" stroke="blue" />
                        <Shape anchors="1 1 1 1" margin={-3} shape="circle" fill="white" stroke="blue" />
                     </ThreeSegmentLine>
                     <ThreeSegmentLine from="5" to="8" stroke="black">
                        <Shape anchors="0 0 0 0" margin={-3} shape="circle" fill="white" stroke="blue" />
                        <Shape anchors="1 1 1 1" margin={-3} shape="circle" fill="white" stroke="blue" />
                     </ThreeSegmentLine>
                     <ThreeSegmentLine from="6" to="8" stroke="black">
                        <Shape anchors="0 0 0 0" margin={-3} shape="circle" fill="white" stroke="blue" />
                        <Shape anchors="1 1 1 1" margin={-3} shape="circle" fill="white" stroke="blue" />
                     </ThreeSegmentLine>
                     <ThreeSegmentLine from="7" to="8" stroke="black">
                        <Shape anchors="0 0 0 0" margin={-3} shape="circle" fill="white" stroke="blue" />
                        <Shape anchors="1 1 1 1" margin={-3} shape="circle" fill="white" stroke="blue" />
                     </ThreeSegmentLine>
                  </Flow>
